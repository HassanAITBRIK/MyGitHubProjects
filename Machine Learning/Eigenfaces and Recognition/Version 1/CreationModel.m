function [CLASS_VECTOR,AVERAGE_FACE,EIGEN_FACES] = CreationModel(DATA_SET)
...
DIFF_FROM_AVERAGE = [];
for i = 1:M
    DIFF_FROM_AVERAGE(:,i) = reshape(DATA_SET{i}-AVERAGE_FACE,N^2,1);
end
%%
...
EIGEN_FACES = EIGEN_FACES(:,1:M_prime);
%%
