function [W1,B1,W2,B2,L,LR,HLayer] = mlpv2atrain(Base, Target, W1, B1, W2, B2, lr, n, err_glob, freqplot);
%
% MLPV2ATRAIN
%
% SYNTAXE :
%
% [W1,B1,W2,B2,L,LR,HLAYER]=mlpv2atrain(Base, Target, W1, B1, W2, B2 [, lr, n, err_glob] [, freqplot]);
%
