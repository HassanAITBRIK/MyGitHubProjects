function [Eigv, EigvRel] = spacedim2(data, neigv, plotflag)
% usage: [Eigv, EigvRel] = spacedim2(data, neigv, plotflag)
%
...
% SPACEDIM
% Charlie Couverture - ISIR/SIMA UPMC <couverture@isir.fr>
% Création : 27 janvier 2009
% Version : 1.0
% Dernieres révisions : 
%  - 
%
...
%Eigv = log10(1+Eigv);           % échelle logarithmique
%Eigv = Eigv/max(Eigv);          % re-normalisation à 1            
EigvRel = [Eigv()];
