function [W1,B1,W2,B2,L,HLayer] = mlp2vtrain(Base, Target, W1, B1, W2, B2, lr, n, err_glob, freqplot);
%
% MLP2TRAIN
%
% SYNTAXE :
%
% [W1,B1,W2,B2,L [,HLayer]]=mlpv2train(Base, Target, W1, B1, W2, B2, lr, n, err_glob [, freqplot]);
%
